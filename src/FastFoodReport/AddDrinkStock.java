...
public class AddDrinkStock extends javax.swing.JFrame {
    private ConnectDB db = new ConnectDB();
    private DefaultTableModel model;
    public AddDrinkStock() {
        initComponents();
    ...
    private void GetDrink(){
        ...
        for(int i=0;i<List_StockDrink.liststockdrink.size();i++){
            Object row[]={
                List_StockDrink.liststockdrink.get(i).getCode(),
                List_StockDrink.liststockdrink.get(i).getName(),
                List_StockDrink.liststockdrink.get(i).getPrice(),
                List_StockDrink.liststockdrink.get(i).getImage(),
            };
            model.addRow(row);
        }
    ...
    private void btnaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaddActionPerformed
        ...
        db.AddDrink(code,name,price,image);
        GetDrink();
        Clear();
    ...
    private void btnupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnupdateActionPerformed
        if(JOptionPane.showConfirmDialog(null, "Do you want to update?", "UPDATE DRINK", JOptionPane.YES_NO_OPTION)==JOptionPane.YES_NO_OPTION){
            ...
            double price = Double.parseDouble(txtprice.getText());
            String image = txtimage.getText();
            db.UpdateDrink(code,name,price,image);
            GetDrink();
            Clear();
        }
    ...
    private void btnremoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnremoveActionPerformed
        if(JOptionPane.showConfirmDialog(null, "Do you want to remove?", "UPDATE DRINK", JOptionPane.YES_NO_OPTION)==JOptionPane.YES_NO_OPTION){
             db.RemoveDrink(Integer.parseInt(txtcode.getText()));
            GetDrink();
            Clear();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddDrinkStock.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddDrinkStock().setVisible(true);
            }
        });
    }
